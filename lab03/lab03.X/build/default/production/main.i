...
cont_hexadecimal:
    btfsc PORTA, 0
    call antirebote_incre
    btfsc PORTA, 1
    call antirebote_decre
    return

;esta seccion sirve para analizar el push botton para aumentar el conteo para contador 1

antirebote_incre:
    btfsc PORTA, 0 ; verificando el valor de entrada de ((PORTA) and 07Fh), 0
    goto $-1
    incf cont ; incremento en 1 el puerto B
    movf cont, W
    call tabla_display
    movwf PORTC
    return
...
antirebote_decre:
    btfsc PORTA, 1 ; verificando el valor de entrada de ((PORTA) and 07Fh), 1
    goto $-1
    decf cont ; decrementando en 1 el puerto B
    movf cont, W
    call tabla_display
    movwf PORTC
    return
