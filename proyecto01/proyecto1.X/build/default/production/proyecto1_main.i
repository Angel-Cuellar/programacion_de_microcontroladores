...
isr:
    btfsc ((INTCON) and 07Fh), 0 ; reviso el valor de la bandera del INTERRUMP ON CHANGE
    call inter_OC ;llamar a la funcion decrementar el tiempo en semaforos

    btfsc ((INTCON) and 07Fh), 2 ;reviso el valor de la bandera de interrupcion del timer0
