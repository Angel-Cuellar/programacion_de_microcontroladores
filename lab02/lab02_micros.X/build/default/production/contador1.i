...
main:
    banksel ANSEL ;
    clrf ANSEL ; definiendo los puertos de ((PORTA) and 07Fh), 0 -((PORTA) and 07Fh), 7 como I/O digital
    clrf ANSELH ; definiendo los puertos de ((PORTB) and 07Fh), 0 -((PORTB) and 07Fh), 7 como I/O digital

    banksel TRISA ;
    clrf TRISA ; definiendo como salidas digitales de ((PORTA) and 07Fh), 0 -((PORTA) and 07Fh), 7
    bsf TRISA , 0 ; definiendo como entrada digital ((PORTA) and 07Fh), 0
    bsf TRISA , 1 ; definiendo como entrada digital ((PORTA) and 07Fh), 1
    bsf TRISA , 2 ; definiendo como entrada digital ((PORTA) and 07Fh), 2
    bsf TRISA , 3 ; definiendo como entrada digital ((PORTA) and 07Fh), 3
    bsf TRISA , 4 ; definiendo como entrada digital ((PORTA) and 07Fh), 4

    clrf TRISB
    bsf TRISB , 4 ; definiendo como entrada digital ((PORTB) and 07Fh), 5
    bsf TRISB , 5 ; definiendo como entrada digital ((PORTB) and 07Fh), 5
    bsf TRISB , 6 ; definiendo como entrada digital ((PORTB) and 07Fh), 6
    bsf TRISB , 7 ; definiendo como entrada digital ((PORTB) and 07Fh), 7

    clrf TRISC
    bsf TRISC , 4 ; definiendo como entrada digital ((PORTC) and 07Fh), 5
    bsf TRISC , 5 ; definiendo como entrada digital ((PORTC) and 07Fh), 5
    bsf TRISC , 6 ; definiendo como entrada digital ((PORTC) and 07Fh), 6
    bsf TRISC , 7 ; definiendo como entrada digital ((PORTC) and 07Fh), 7

    clrf TRISD
    bsf TRISD , 5 ; definiendo como entrada digital ((PORTD) and 07Fh), 5
    bsf TRISD , 6 ; definiendo como entrada digital ((PORTD) and 07Fh), 6
    bsf TRISD , 7 ; definiendo como entrada digital ((PORTD) and 07Fh), 7
...
;esta seccion sirve para analizar el push botton para aumentar el conteo push 1
...
;esta seccion sirve para analizar el push botton para disminuir el conteo push 2
...
anti_rebote_decremento_1:
    ...
    decf PORTB, F
    return
;esta seccion sirve para analizar el push botton para aumentar el conteo push 3
...
;esta seccion sirve para analizar el push botton para disminuir el conteo push 4
