...
isr:
    btfsc ((INTCON) and 07Fh), 2 ; reviso el valor de la bandera de la interrupcion del timer0
...
conf_timer0:
    ...
    bcf ((OPTION_REG) and 07Fh), 0 ;PS = 010 /1:8
    reset_timer0
    return
...
conf_timer1:
    ...
    bsf ((T1CON) and 07Fh), 5 ;usar prescaler
    bsf ((T1CON) and 07Fh), 4 ;PS = 11 /1:8
    bcf ((T1CON) and 07Fh), 3
    bcf ((T1CON) and 07Fh), 2
...
conf_timer2:
    ...
    bcf ((T2CON) and 07Fh), 4 ;usar post-scaler
    bcf ((T2CON) and 07Fh), 5 ;POS = 1001 / 1:10
    bsf ((T2CON) and 07Fh), 6
    bsf ((T2CON) and 07Fh), 2
    bsf ((T2CON) and 07Fh), 0 ;usar prescaler
    bsf ((T2CON) and 07Fh), 1 ;PS = 01 / 1:16
    banksel TRISA
